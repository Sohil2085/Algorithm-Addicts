...
const WalletLoadingOverlay = () => {
    return (
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-[1px]">
            <div className="bg-slate-900/80 border border-white/10 rounded-2xl p-6 shadow-[0_0_50px_rgba(0,0,0,0.4)] backdrop-blur-xl flex flex-col items-center max-w-sm w-full mx-4">
