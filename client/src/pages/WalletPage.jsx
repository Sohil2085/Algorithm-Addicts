                    ...
                    <div className={`transition-all duration-300 ${loading ? 'pointer-events-none blur-[2px] opacity-60' : ''}`}>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="space-y-6">
                                {isLender && (
                                    <div className="bg-white/5 border border-white/10 rounded-3xl p-6 shadow-xl relative overflow-hidden backdrop-blur-xl group hover:border-blue-500/30 transition-all duration-500 mb-6">
                                ...
                                <div className="bg-white/5 border border-white/10 rounded-3xl p-6 shadow-xl backdrop-blur-xl group hover:border-blue-500/30 transition-all duration-500">
                                    ...
                                    <p className="text-sm text-slate-400 mb-6">Automatically withdraw your available balance to your registered bank account.</p>
